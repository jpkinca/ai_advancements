...
do {
    ...
    switch ($choice) {
        ...
        "4" {
            ...
            Write-Host "===============================" -ForegroundColor Green
            Write-Host "⚠️  This may take 30-60 minutes to complete" -ForegroundColor Yellow
        ...
        "5" {
            ...
            Write-Host "=====================================" -ForegroundColor Green
            Write-Host "⚠️  This will run all daily routines in sequence" -ForegroundColor Yellow
